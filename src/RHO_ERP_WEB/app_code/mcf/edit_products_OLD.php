                                                ...
                                                <div  class="col-md-12 input-group" style="padding-right: 0px !important; padding-left: 0px !important;">
                                                    ...
                                                    <div class="col-md-4" style="padding-left:0px;padding-right: 0px;">
                                                        <select <?php echo $mkReadOnlyDsbld; ?> class="form-control" id="feeApplctnType" >
                                                            ...
                                                            <option value="Maturity" <?php echo $sltdMtrty; ?>>Maturity</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="<?php echo $prdtDivCls; ?>" id="PrdtDiv">
                                                    <fieldset class="basic_person_fs5"><legend class="basic_person_lg1">Product</legend>
                                                        ...
                                                        <div class="form-group form-group-sm">
                                                            ...
                                                            <div  class="col-md-8">
                                                                <textarea <?php echo $mkReadOnly; ?> class="form-control rqrdFld" id="prdtDesc" cols="2" placeholder="Description" rows="3"><?php echo $row[3]; ?></textarea>
                                                            </div>
                                                        </div>                                                            
                                                        <div class="form-group form-group-sm">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'cashDepositDbtAccID', 'cashDepositDbtAcc', 'clear', 1, '');">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'cashDepositCrdtAccID', 'cashDepositCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'chqDepositDbtAccID', 'chqDepositDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'chqDepositCrdtAccID', 'chqDepositCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'cashWtdwlDbtAccID', 'cashWtdwlDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'cashWtdwlCrdtAccID', 'cashWtdwlCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'entryFeesDbtAccID', 'entryFeesDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'entryFeesCrdtAccID', 'entryFeesCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'closeFeesDbtAccID', 'closeFeesDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'closeFeesCrdtAccID', 'closeFeesCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'reopenFeesDbtAccID', 'reopenFeesDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'reopenFeesCrdtAccID', 'reopenFeesCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'wtdwlPnltyFlatDbtAccID', 'wtdwlPnltyFlatDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'wtdwlPnltyFlatCrdtAccID', 'wtdwlPnltyFlatCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'wtdwlPnltyPrcntDbtAccID', 'wtdwlPnltyPrcntDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'wtdwlPnltyPrcntCrdtAccID', 'wtdwlPnltyPrcntCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'cotFeeFlatDbtAccID', 'cotFeeFlatDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'cotFeeFlatCrdtAccID', 'cotFeeFlatCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'invstmntFeeDbtAccID', 'invstmntFeeDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'invstmntFeeCrdtAccID', 'invstmntFeeCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'interesPyblDbtAccID', 'interesPyblDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'interesPyblCrdtAccID', 'interesPyblCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'interesExpenseDbtAccID', 'interesExpenseDbtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'interesExpenseCrdtAccID', 'interesExpenseCrdtAcc', 'clear', 1, '');">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'cashDepositCrdtAccID', 'cashDepositCrdtAcc', 'clear', 1, '', function(){
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'cashWtdwlDbtAccID', 'cashWtdwlDbtAcc', 'clear', 1, '', function(){
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'wtdwlPnltyFlatDbtAccID', 'wtdwlPnltyFlatDbtAcc', 'clear', 1, '', function(){
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'cotFeeFlatDbtAccID', 'cotFeeFlatDbtAcc', 'clear', 1, '', function(){
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'interesPyblCrdtAccID', 'interesPyblCrdtAcc', 'clear', 1, '', function(){
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'interesExpenseDbtAccID', 'interesExpenseDbtAcc', 'clear', 1, '', function(){
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'interesExpenseCrdtAccID', 'interesExpenseCrdtAcc', 'clear', 1, '', function(){
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div  class="col-md-8">
                                                    <div class="input-group">
                                                        ...
                                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'prncplRcvblDbtAccID', 'prncplRcvblDbtAcc', 'clear', 1, '');">
                                                            <span class="glyphicon glyphicon-th-list"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div  class="col-md-8">
                                                    <div class="input-group">
                                                        ...
                                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'loansPybleCrdtAccID', 'loansPybleCrdtAcc', 'clear', 1, '');">
                                                            <span class="glyphicon glyphicon-th-list"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div  class="col-md-8">
                                                    <div class="input-group">
                                                        ...
                                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'intrstRcvblDbtAccID', 'intrstRcvblDbtAcc', 'clear', 1, '');">
                                                            <span class="glyphicon glyphicon-th-list"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div  class="col-md-8">
                                                    <div class="input-group">
                                                        ...
                                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'dfrdIntrstCrdtAccID', 'dfrdIntrstCrdtAcc', 'clear', 1, '');">
                                                            <span class="glyphicon glyphicon-th-list"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div  class="col-md-8">
                                                    <div class="input-group">
                                                        ...
                                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'intrstRvnueCrdtAccID', 'intrstRvnueCrdtAcc', 'clear', 1, '');">
                                                            <span class="glyphicon glyphicon-th-list"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div  class="col-md-8">
                                                    <div class="input-group">
                                                        ...
                                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'badDebtExpnsAccID', 'badDebtExpnsAcc', 'clear', 1, '');">
                                                            <span class="glyphicon glyphicon-th-list"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div  class="col-md-8">
                                                    <div class="input-group">
                                                        ...
                                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'prvsnExpnsAccID', 'prvsnExpnsAcc', 'clear', 1, '');">
                                                            <span class="glyphicon glyphicon-th-list"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div  class="col-md-8">
                                                    <div class="input-group">
                                                        ...
                                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'prvsnContraAccID', 'prvsnContraAcc', 'clear', 1, '');">
                                                            <span class="glyphicon glyphicon-th-list"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                                        ...
                                                                        . "<td class=\"lovtd\"><span class=\"normaltd\">New</span></td>
                                                                            ...
                                                                            <td class=\"lovtd\">                                                                         
                                                                                <div class=\"input-group\">
                                                                                    ...
                                                                                    <label class=\"btn btn-primary btn-file input-group-addon\" onclick=\"getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '', 'allPrcsnFeesRow_WWW123WWW_RvnAcctID', 'allPrcsnFeesRow_WWW123WWW_RvnAcct', 'clear', 1, '');\">
                                                                                         <span class=\"glyphicon glyphicon-th-list\"></span>
                                                                                    </label>
                                                                    ...
                                                                    <tr id="allPrcsnFeesRow_<?php echo $cntr; ?>">                                    
                                                                        ...
                                                                        <td class="lovtd">  
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '', 'allPrcsnFeesRow<?php echo $cntr; ?>_RvnAcctID', 'allPrcsnFeesRow<?php echo $cntr; ?>_RvnAcct', 'clear', 1, '');">
                                                                                        <span class="glyphicon glyphicon-th-list"></span>
                                                                                </label>
                                                                                        ...
                                                                                        . "<td class=\"lovtd\"><span class=\"normaltd\">New</span></td>
                                                                                                ...
                                                                                                <td style=\"display:none !important;\" class=\"lovtd\">                                                                         
                                                                                                        <div class=\"input-group\">
                                                                                                                ...
                                                                                                                <label class=\"btn btn-primary btn-file input-group-addon\" onclick=\"getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '', 'allLatePymntFeesRow_WWW123WWW_DbtAcctID', 'allLatePymntFeesRow_WWW123WWW_DbtAcct', 'clear', 1, '');\">
                                                                                                                         <span class=\"glyphicon glyphicon-th-list\"></span>
                                                                                                                </label>
                                                                                                ...
                                                                                                <td class=\"lovtd\">                                                                         
                                                                                                        <div class=\"input-group\">
                                                                                                                ...
                                                                                                                <label class=\"btn btn-primary btn-file input-group-addon\" onclick=\"getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '', 'allLatePymntFeesRow_WWW123WWW_CrdtAcctID', 'allLatePymntFeesRow_WWW123WWW_CrdtAcct', 'clear', 1, '');\">
                                                                                                                         <span class=\"glyphicon glyphicon-th-list\"></span>
                                                                                                                </label>
                                                                    ...
                                                                    <tr id="allLatePymntFeesRow_<?php echo $cntr; ?>">                                    
                                                                        ...
                                                                        <td style="display:none !important;" class="lovtd">  
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '', 'allLatePymntFeesRow<?php echo $cntr; ?>_DbtAcctID', 'allPrcsnFeesRow<?php echo $cntr; ?>_DbtAcct', 'clear', 1, '');">
                                                                                        <span class="glyphicon glyphicon-th-list"></span>
                                                                                </label>
                                                                        ...
                                                                        <td class="lovtd"> 
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '', 'allLatePymntFeesRow<?php echo $cntr; ?>_CrdtAcctID', 'allPrcsnFeesRow<?php echo $cntr; ?>_CrdtAcct', 'clear', 1, '');">
                                                                                        <span class="glyphicon glyphicon-th-list"></span>
                                                                                </label>
