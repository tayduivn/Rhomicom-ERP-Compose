    ...
    if ($lgn_num > 0) {
        ...
        <form id='lovForm' action='' method='post' accept-charset='UTF-8'>
            ...
            <div class="row" style="float:right;padding-right: 15px;">
                ...
                <button type="button" class="btn btn-primary" onclick="applySlctdLov_mcf('<?php echo $modalElementID; ?>', 'lovForm', '<?php echo $valueElmntID; ?>', '<?php echo $descElemntID; ?>',<?php echo $callBackFunc ?>);">Apply Selection</button>
            </div>
        </form>
        <?php
    }
