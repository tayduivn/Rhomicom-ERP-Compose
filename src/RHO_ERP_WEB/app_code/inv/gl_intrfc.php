    ...
    if ($lgn_num > 0 && $canview === true) {
        if ($qstr == "DELETE") {
                ...
                if ($canDelTrns) {
                    for ($z = 0; $z < count($variousRows); $z++) {
                        ...
                        if (count($crntRow) == 2) {
                            ...
                            $affctd1 += deleteINVTrnsGLIntFcLn($intrfcID, $intrfcIDDesc);
                        }
                    }
                    if ($affctd1 > 0) {
            ...
            if ($actyp == 1) {
                ...
                if ($glIntrfcTrnsDesc != "" && $glIntrfcTrnsDate != "" && $incrsDcrs != "" && $intrfcAccntID > 0 && $enteredAmount != 0 && $enteredCrncyID > 0) {
                    ...
                    if (dbtOrCrdtAccnt($intrfcAccntID, substr($incrsDcrs, 0, 1)) == "Debit") {
                        if ($glIntrfcTrnsID <= 0) {
                            createINVTrnsGLIntFcLn($intrfcAccntID, $glIntrfcTrnsDesc, $funcCrncyAmount, $glIntrfcTrnsDate,
                            ...
                            updateINVTrnsGLIntFcLn($glIntrfcTrnsID, $intrfcAccntID, $glIntrfcTrnsDesc, $funcCrncyAmount,
                                    $glIntrfcTrnsDate, $funcCurrID, 0, $netamnt, "Imbalance Correction", -1, -1, $dateStr, "",
                                    "USR", $enteredAmount, $enteredCrncyID, $accntCrncyAmount, $accntCurrID, $funcCrncyRate,
                                    $accntCrncyRate);
                        }
                    } else {
                        if ($glIntrfcTrnsID <= 0) {
                            createINVTrnsGLIntFcLn($intrfcAccntID, $glIntrfcTrnsDesc, 0, $glIntrfcTrnsDate, $funcCurrID,
                                    $funcCrncyAmount, $netamnt, "Imbalance Correction", -1, -1, $dateStr, "", "USR",
                                    $enteredAmount, $enteredCrncyID, $accntCrncyAmount, $accntCurrID, $funcCrncyRate,
                                    $accntCrncyRate);
                        } else {
                            updateINVTrnsGLIntFcLn($glIntrfcTrnsID, $intrfcAccntID, $glIntrfcTrnsDesc, 0, $glIntrfcTrnsDate,
            ...
            if ($vwtyp == 0) {
                ...
                $total = 1000000; //get_INVGlIntrfcTtl($srchFor, $srchIn, $orgID, $qStrtDte, $qEndDte, $qNotSentToGl, $qUnbalncdOnly, $qUsrGnrtd, $qLowVal, $qHighVal);
                ...
                $curIdx = $pageNo - 1;
                $result = get_INVGlIntrfc(
                        $srchFor, $srchIn, $curIdx, $lmtSze, $orgID, $qStrtDte, $qEndDte, $qNotSentToGl, $qUnbalncdOnly,
                        $qUsrGnrtd, $qLowVal, $qHighVal
                );
                $cntr = 0;
                ?> 
                <form id='allINVGLIntrfcsForm' action='' method='post' accept-charset='UTF-8'>
                    <div class="row " style="margin-bottom:0px;padding:0px 15px 0px 15px !important;">
                        <div class="col-lg-3" style="padding:0px 1px 0px 1px !important;">
                            <div class="input-group">
                                <input class="form-control" id="allINVGLIntrfcsSrchFor" type = "text" placeholder="Search For" value="<?php
                                echo trim(str_replace("%", " ", $srchFor));
                                ?>" onkeyup="enterKeyFuncAllINVGLIntrfcs(event, '', '#allmodules', 'grp=<?php echo $group; ?>&typ=<?php echo $type; ?>&pg=<?php echo $pgNo; ?>&vtyp=<?php echo $vwtyp; ?>')">
                                <input id="allINVGLIntrfcsPageNo" type = "hidden" value="<?php echo $pageNo; ?>">
                                <label class="btn btn-primary btn-file input-group-addon" onclick="getAllINVGLIntrfcs('clear', '#allmodules', 'grp=<?php echo $group; ?>&typ=<?php echo $type; ?>&pg=<?php echo $pgNo; ?>&vtyp=<?php echo $vwtyp; ?>')">
                                    <span class="glyphicon glyphicon-remove"></span>
                                </label>
                                <label class="btn btn-primary btn-file input-group-addon" onclick="getAllINVGLIntrfcs('', '#allmodules', 'grp=<?php echo $group; ?>&typ=<?php echo $type; ?>&pg=<?php echo $pgNo; ?>&vtyp=<?php echo $vwtyp; ?>');">
                        ...
                        <div class="col-lg-3" style="padding:0px 1px 0px 1px !important;">
                            <div class="input-group">
                                ...
                                <select data-placeholder="Select..." class="form-control chosen-select" id="allINVGLIntrfcsSrchIn">
                                    <?php
                                    $valslctdArry = array("", "", "", "", "");
                                ...
                                <select data-placeholder="Select..." class="form-control chosen-select" id="allINVGLIntrfcsDsplySze" style="min-width:65px !important;">                            
                                    <?php
                                    $valslctdArry = array("", "", "", "", "", "",
                                        "", "");
                        ...
                        <div class="col-lg-4" style="padding:0px 1px 0px 1px !important;">
                            <div class="col-xs-6" style="padding:0px 1px 0px 0px !important;">
                                <div class="input-group date form_date" data-date="" data-date-format="dd-M-yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                    <input class="form-control" size="16" type="text" id="allINVGLIntrfcsStrtDate" name="allINVGLIntrfcsStrtDate" value="<?php
                            ...
                            <div class="col-xs-6" style="padding:0px 1px 0px 0px !important;">
                                <div class="input-group date form_date" data-date="" data-date-format="dd-M-yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                    <input class="form-control" size="16" type="text"  id="allINVGLIntrfcsEndDate" name="allINVGLIntrfcsEndDate" value="<?php
                        ...
                        <div class="col-lg-2" style="padding:0px 1px 0px 1px !important;">
                            <nav aria-label="Page navigation">
                                <ul class="pagination" style="margin: 0px !important;">
                                    <li>
                                        <a class="rhopagination" href="javascript:getAllINVGLIntrfcs('previous', '#allmodules', 'grp=<?php echo $group; ?>&typ=<?php echo $type; ?>&pg=<?php echo $pgNo; ?>&vtyp=<?php echo $vwtyp; ?>');" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="rhopagination" href="javascript:getAllINVGLIntrfcs('next', '#allmodules', 'grp=<?php echo $group; ?>&typ=<?php echo $type; ?>&pg=<?php echo $pgNo; ?>&vtyp=<?php echo $vwtyp; ?>');" aria-label="Next">
                    ...
                    <div class="row " style="margin-bottom:2px;padding:2px 15px 2px 15px !important">   
                        <div class="col-md-12" style="padding:2px 1px 2px 1px !important;border-top:1px solid #ddd;border-bottom:1px solid #ddd;">
                            <div class="col-md-3" style="padding:5px 1px 0px 1px !important;">
                                <div class="form-check" style="font-size: 12px !important;">
                                    <label class="form-check-label">
                                        ...
                                        ?>
                                        <input type="checkbox" class="form-check-input" onclick="getAllINVGLIntrfcs('', '#allmodules', 'grp=<?php echo $group; ?>&typ=<?php echo $type; ?>&pg=<?php echo $pgNo; ?>&vtyp=<?php echo $vwtyp; ?>');" id="allINVGLIntrfcsSntToGl" name="allINVGLIntrfcsSntToGl" <?php echo $notToGlChekd; ?>>
                            ...
                            <div class="col-md-3" style="padding:5px 1px 0px 1px !important;">
                                <div class="form-check" style="font-size: 12px !important;">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" onclick="getAllINVGLIntrfcs('', '#allmodules', 'grp=<?php echo $group; ?>&typ=<?php echo $type; ?>&pg=<?php echo $pgNo; ?>&vtyp=<?php echo $vwtyp; ?>');" id="allINVGLIntrfcsUnbalncd" name="allINVGLIntrfcsUnbalncd"  <?php echo $notBalcdChekd; ?>>
                            ...
                            <div class="col-md-2" style="padding:5px 1px 0px 1px !important;">
                                <div class="form-check" style="font-size: 12px !important;">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" onclick="getAllINVGLIntrfcs('', '#allmodules', 'grp=<?php echo $group; ?>&typ=<?php echo $type; ?>&pg=<?php echo $pgNo; ?>&vtyp=<?php echo $vwtyp; ?>');" id="allINVGLIntrfcsUsrTrns" name="allINVGLIntrfcsUsrTrns"  <?php echo $usrTrnsChekd; ?>>
                                        User Generated Trns.
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-2" style="padding:0px 1px 0px 1px !important;">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="allINVGLIntrfcsLowVal" type = "number" placeholder="Low Value" value="<?php
                                    echo $qLowVal;
                                    ?>" onkeyup="enterKeyFuncAllINVGLIntrfcs(event, '', '#allmodules', 'grp=<?php echo $group; ?>&typ=<?php echo $type; ?>&pg=<?php echo $pgNo; ?>&vtyp=<?php echo $vwtyp; ?>')">
                                </div>
                            </div>   
                            <div class="col-md-2" style="padding:0px 1px 0px 1px !important;">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="allINVGLIntrfcsHighVal" type = "number" placeholder="High Value" value="<?php
                                    echo $qHighVal;
                                    ?>" onkeyup="enterKeyFuncAllINVGLIntrfcs(event, '', '#allmodules', 'grp=<?php echo $group; ?>&typ=<?php echo $type; ?>&pg=<?php echo $pgNo; ?>&vtyp=<?php echo $vwtyp; ?>')">
                                </div>
                            </div>
                        ...
                        <div class="col-md-12" style="padding:0px 0px 0px 0px !important;border-top:1px solid #ddd;border-bottom:1px solid #ddd;">
                            <div class="col-md-4" style="padding:2px 1px 2px 1px !important;">
                                <div class="input-group">
                                    ...
                                    <?php
                                    $dffrc = (float) getINVGLIntrfcDffrnc($orgID);
                                    $style1 = "color:green;";
                                    if (abs($dffrc) != 0) {
                                        $style1 = "color:red;";
                                    }
                                    ?>
                                    <input class="form-control" id="allINVGLIntrfcsImbalsAmt" type = "text" placeholder="0.00" value="<?php
                            ...
                            <div class="col-md-8" style="padding:2px 1px 2px 1px !important;">
                                <?php if ($canAddCrctnTrns && abs($dffrc) != 0) { ?>
                                    <button type="button" class="btn btn-default btn-sm" onclick="getOneINVGLIntrfcForm(-1);">
                                        <img src="cmn_images/add1-64.png" style="left: 0.5%; padding-right: 5px; height:20px; width:auto; position: relative; vertical-align: middle;">
                                        Add Correction Trns.
                                    </button>
                                <?php } ?>                           
                                <?php if ($canDelCrctnTrns) { ?>
                                    <button type="button" class="btn btn-default btn-sm" onclick="delSlctdINVIntrfcLines();">
                                ...
                                <?php
                                if ($canSendToGl === true) {
                                    $reportTitle = "Journal Import from Inventory Module-Web";
                                    $reportName = "Journal Import from Inventory Module-Web";
                                    $rptID = getRptID($reportName);
                                    $prmID1 = getParamIDUseSQLRep("{:glbatch_name}", $rptID);
                                    $prmID2 = getParamIDUseSQLRep("{:intrfc_tbl_name}", $rptID);
                                    $glBtchNm = "%Inventory%";
                                    $pIntrfcTblNm = "scm.scm_gl_interface";
                ...
                <form id='allINVGLIntrfcsHdrsForm' action='' method='post' accept-charset='UTF-8'>
                    <div class="row"> 
                        <div  class="col-md-12">
                            <table class="table table-striped table-bordered table-responsive" id="allINVGLIntrfcsHdrsTable" cellspacing="0" width="100%" style="width:100%;">
                                <thead>
                                    <tr>
                                        <th>&nbsp;</th>
                                        <th>No.</th>
                                ...
                                <tbody>
                                    ...
                                    while ($row = loc_db_fetch_array($result)) {
                                        /**/
                                        $cntr += 1;
                                        $ttlDEBIT += (float) $row[5];
                                        $ttlCREDIT += (float) $row[6];
                                        ?>
                                        <tr id="allINVGLIntrfcsHdrsRow_<?php echo $cntr; ?>">
                                            <td class="lovtd">
                                                <input type="checkbox" name="allINVGLIntrfcsHdrsRow<?php echo $cntr; ?>_CheckBox" value="<?php echo $row[0] . ";" . $row[1]; ?>">
                                                <input type="hidden" value="<?php echo $row[0]; ?>" id="allINVGLIntrfcsHdrsRow<?php echo $cntr; ?>_AccntID">
                                                <input type="hidden" value="<?php echo $row[11]; ?>" id="allINVGLIntrfcsHdrsRow<?php echo $cntr; ?>_IntrfcID">
                                            </td>                                    
                                            ...
                                            <td class="lovtd" style="text-align:right;font-weight:bold;color:blue;"><?php
                                                echo number_format((float) $row[5],
                                                        2);
                                                ?></td>
                                            <td class="lovtd" style="text-align:right;font-weight:bold;color:blue;"><?php
                                                echo number_format((float) $row[6],
                                                        2);
                                                ?></td>
                                            ...
                                            <td class="lovtd">                                                     
                                                <button type="button" class="btn btn-default btn-sm" onclick="getOneINVGLIntrfcForm(<?php echo $row[11]; ?>, 'allINVGLIntrfcsHdrsRow_<?php echo $cntr; ?>');" data-toggle="tooltip" data-placement="bottom" title="View Details" style="padding:2px !important;">
                                            ...
                                            <?php if ($canVwRcHstry === true) { ?>
                                                <td class="lovtd">
                                                    ...
                                                    echo urlencode(encrypt1(($row[11] . "|scm.scm_gl_interface|interface_id"),
                                                                    $smplTokenWord1));
                                ...
                                <?php if ($qUnbalncdOnly == true) { ?>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th style="text-align:right;min-width: 100px;width: 100px;color:red;font-weight:bold;"><?php echo number_format($ttlDEBIT, 2); ?></th>
                                            <th style="text-align:right;min-width: 100px;width: 100px;color:red;font-weight:bold;"><?php echo number_format($ttlCREDIT, 2); ?></th>
                                            <th>&nbsp;</th>
                                            <th>&nbsp;</th>
                                            <th>&nbsp;</th>                                          
                                            <th>&nbsp;</th>
                ...
                $mkReadOnly = "";
                if ($sbmtdIntrfcID > 0) {
                    $result = get_OneINVGlIntrfcDet($sbmtdIntrfcID);
                    while ($row = loc_db_fetch_array($result)) {
                    ...
                    $dfrnce = round(getINVGLIntrfcDffrnc($orgID), 2);
                    if ($dfrnce == 0) {
                    ...
                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <?php if ($canEdtIntrfc === true) { ?>  
                                                <div class="input-group">                                    
                                                    ...
                                                    ?>"  style="font-weight:bold;" onchange="afterINVIntrfcItemSlctn();"/>
                                                </div>
                                            <?php } else { ?>
                        ...
                        <div class="row" style="float:right;padding-right: 30px;margin-top: 5px;">
                            ...
                            <?php if ($canEdtIntrfc === true && $glBatchID <= 0) { //&& $trnsSource != "SYS"    ?>
                                <button type="button" class="btn btn-primary" onclick="saveINVGLIntrfcForm();">Save Changes</button>
                            <?php } ?>
                        </div>
                    </div>
                </form>                    
