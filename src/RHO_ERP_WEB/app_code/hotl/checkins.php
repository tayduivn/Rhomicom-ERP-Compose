    ...
    if ($lgn_num > 0 && $canview === true) {
        if ($qstr == "DELETE") {
            ...
            if ($actyp == 1) {
                ...
                if ($hotlChckinDocRmID <= 0) {
                    $exitErrMsg .= "Facility Number cannot be empty!<br/>";
                }
                if ($hotlChckinDocSpnseeID <= 0 || $hotlChckinDocSpnsrID <= 0) {
                    $exitErrMsg .= "Sponsor and Occupant cannot be empty!<br/>";
                }
                                ...
                                if ($ln_LineDesc != "" && $ln_ItmID > 0 && $ln_QTY > 0) {
                                    if ($ln_TrnsLnID <= 0) {
                                        ...
                                        $afftctd += createSalesDocLn1($ln_TrnsLnID, $sbmtdScmSalesInvcID, $ln_ItmID, $ln_QTY, $ln_UnitPrice,
                                                ...
                                                $ln_ReturnRsn, $ln_CnsgnIDs, $ln_OrgnlPrice, false, $ln_LnkdPrsnID, $ln_LineDesc,
                                        ...
                                        if ($ln_OthrMdlID == $sbmtdHotlChckinDocID && $ln_OthrMdlTyp == $hotlChckinDocVchType) {
                                            ...
                                            $afftctd += updateSalesDocLn3($ln_TrnsLnID, $ln_ItmID, $ln_QTY, $ln_StoreID,
                                                    $scmSalesInvcInvcCurID, $ln_SrcDocLnID, $ln_TaxID, $ln_DscntID, $ln_ChrgID,
                                                    $ln_ReturnRsn, $ln_CnsgnIDs, false, $ln_LnkdPrsnID, $ln_LineDesc, $ln_AstAcntID,
            ...
            if ($vwtyp == 0) {
                ...
                if ($srcModule === "allmodules") {
                    echo $cntent . "<li onclick=\"openATab('#allmodules', 'grp=$group&typ=$type&pg=$pgNo&vtyp=0');\">
                                    ...
                                    <span style=\"text-decoration:none;\">Reservations & Checkins</span>
				</li>
                               </ul>
                              </div>";
                }
                ...
                $extrWhere = " and a.doc_type IN ('Reservation', 'Check-In') and a.fclty_type IN ('Room/Hall','Field/Yard')";
                ...
                <form id='hotlChckinDocForm' action='' method='post' accept-charset='UTF-8'>
                    ...
                    <fieldset class=""><legend class="basic_person_lg1" style="color: #003245">ALL CHECK-INS/RESERVATIONS</legend>
                            ...
                            <div class="col-md-12" style="padding:2px 1px 2px 1px !important;border-top:1px solid #ddd;border-bottom:1px solid #ddd;">
                                <?php if ($canAdd === true && $srcModule === "allmodules") { ?>   
                                    <div class="col-md-5" style="padding:0px 0px 0px 0px !important;">                      
                                        <button type="button" class="btn btn-default" style="margin-bottom: 0px;" onclick="getOneHotlChckinDocForm(-1, 3, 'ShowDialog', 'Check-In', 'CHECK-IN', '<?php echo $srcModule; ?>');" data-toggle="tooltip" data-placement="bottom" title="Add New Check-In">
                                            <img src="cmn_images/add1-64.png" style="left: 0.5%; padding-right: 5px; height:20px; width:auto; position: relative; vertical-align: middle;">
                                            NEW CHECK-IN
                                        </button>                 
                                        <button type="button" class="btn btn-default" style="margin-bottom: 0px;" onclick="getOneHotlChckinDocForm(-1, 3, 'ShowDialog', 'Reservation', 'CHECK-IN', '<?php echo $srcModule; ?>');" data-toggle="tooltip" data-placement="bottom" title="Add New Reservation">
                                            <img src="cmn_images/add1-64.png" style="left: 0.5%; padding-right: 5px; height:20px; width:auto; position: relative; vertical-align: middle;">
                                            NEW RESERVATION
                                        </button> 
                                    </div>  
                                            ...
                                            <tr id="hotlChckinDocHdrsRow_<?php echo $cntr; ?>">                                    
                                                ...
                                                <td class="lovtd">
                                                    <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="View/Edit Document" 
                                                            onclick="getOneHotlChckinDocForm(<?php echo $row[0]; ?>, 3, 'ShowDialog', '<?php echo $row[14]; ?>', 'CHECK-IN', '<?php echo $srcModule; ?>');" style="padding:2px !important;" style="padding:2px !important;">                                                                
                                                                <?php
                                                                if ($canAdd === true) {
                                                                    ?>                                
                ...
                //New Rentals Form
                //var_dump($_POST);
                // + '&ln_FcltyType=' + ln_FcltyType + '&ln_SrvsTypID=' + ln_SrvsTypID + '&ln_RoomID=' + ln_RoomID
                ...
                $srcModule = isset($_POST['srcModule']) ? cleanInputData($_POST['srcModule']) : 'allmodules';
                $sbmtdHotlChckinDocID = isset($_POST['sbmtdHotlChckinDocID']) ? (float) cleanInputData($_POST['sbmtdHotlChckinDocID']) : -1;
                $hotlChckinDocVchType = isset($_POST['hotlChckinDocVchType']) ? cleanInputData($_POST['hotlChckinDocVchType']) : "Check-In";
                ...
                if ($sbmtdln_SrvsTypID > 0 && $sbmtdln_RoomID > 0) {
                    $hotlChckinDocSrvcTypID = $sbmtdln_SrvsTypID;
                    $hotlChckinDocSrvcTyp = getSrvsTypName($hotlChckinDocSrvcTypID);
                    $hotlChckinDocRmID = $sbmtdln_RoomID;
                    $hotlChckinDocRmNum = getRoomName($hotlChckinDocRmID);
                }
                ...
                if ($hotlChckinDocVchType == "Check-In") {
                ...
                $paramStr1 = urlencode($paramRepsNVals1);
				                ...
				                /*CLINIC HOSPITAL*/
                $admsnID  = isset($_POST['admsnID']) ? cleanInputData($_POST['admsnID']) : -1;
                
                if($admsnID == -1){
                    $admsnID = getChkInAdmsnId($sbmtdHotlChckinDocID);
                }
                //$ptntPrsnID  = isset($_POST['ptntPrsnID']) ? cleanInputData($_POST['ptntPrsnID']) : -1;
                if($admsnID > 0){
                    //$sbmtdHotlChckinDocID
                    execUpdtInsSQL("UPDATE hosp.inpatient_admissions SET ref_check_in_id = $sbmtdHotlChckinDocID WHERE admsn_id = $admsnID");
                    
                    //UPDATE CHECKIN AND OUT DATES
                    $inDate = getGnrlRecNm("hosp.inpatient_admissions", "admsn_id", "to_char(to_timestamp(checkin_date,'YYYY-MM-DD'),'DD-Mon-YYYY HH24:MI:SS')", $admsnID);
                    $outDate = getGnrlRecNm("hosp.inpatient_admissions", "admsn_id", "to_char(to_timestamp(checkout_date,'YYYY-MM-DD'),'DD-Mon-YYYY HH24:MI:SS')", $admsnID);                    
                    $detApntmntID = (int)getGnrlRecNm("hosp.inpatient_admissions", "admsn_id", "dest_appntmnt_id", $admsnID);
                    $vstID = (int)getGnrlRecNm("hosp.appntmnt", "appntmnt_id", "vst_id", $detApntmntID);
                    $ptntPrsnID = (int)getGnrlRecNm("hosp.visit", "vst_id", "prsn_id", $vstID);

                    $spnsrId = -1;
                    $spnsrNm = "";
                    $resultXX = executeSQLNoParams("SELECT data_col6, extra_data_id 
                        FROM prs.prsn_extra_data a WHERE ((person_id = $ptntPrsnID))");
                    $rowXXCnt = loc_db_num_fields($resultXX);
                    if($rowXXCnt > 0){
                        while ($rowXX = loc_db_fetch_array($resultXX)) {
                            if($rowXX[0] != ""){
                                //$spnsrId = $rowXX[0];
                                $spnsrNm = $rowXX[0];
                                
                                $resultXX1 = executeSQLNoParams("SELECT cust_sup_id, cust_sup_name
                                    FROM scm.scm_cstmr_suplr a WHERE cust_sup_name = '" . loc_db_escape_string($spnsrNm) . "' AND org_id = $orgID LIMIT 1");
                                $rowXX1Cnt = loc_db_num_fields($resultXX1);
                                if($rowXX1Cnt > 0){
                                    while ($rowXX1 = loc_db_fetch_array($resultXX1)) {
                                        $spnsrId = $rowXX1[0];
                                    }
                                }
                    ...
                    execUpdtInsSQL("UPDATE hotl.checkins_hdr SET sponsor_id = $spnsrId, customer_id = $cstmrId,"
                            . "start_date = to_char(to_timestamp('$inDate','DD-Mon-YYYY HH24:MI:SS'),'YYYY-MM-DD HH24:MI:SS'), "
                            . "end_date = to_char(to_timestamp('$outDate','DD-Mon-YYYY HH24:MI:SS'),'YYYY-MM-DD HH24:MI:SS') WHERE check_in_id = $sbmtdHotlChckinDocID");
                    
                    $hotlChckinDocSpnsr = $spnsrNm;
                    $hotlChckinDocSpnsrID = $spnsrId;
                    
                    $hotlChckinDocSpnsee = $cstmrNm;
                    $hotlChckinDocSpnseeID = $cstmrId;
                    
                    $hotlChckinDocStrtDte = $inDate;
                    $hotlChckinDocEndDte = $outDate;

                }
                
                $cnt10 = isHospitalityLnkdToClinic($sbmtdHotlChckinDocID);
                /*CLINIC HOSPITAL*/
                    ...
                    <fieldset class="basic_person_fs2" style="min-height:50px !important;">
                        <div class="row" style="margin-top:5px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5" style="padding:0px 15px 0px 1px;">
                                        <select data-placeholder="Select..." class="form-control chosen-select" id="hotlChckinFcltyType">
                                            <?php
                                            $valslctdArry = array("", "");
                                            $srchInsArrys = array("Room/Hall", "Field/Yard");
                                            for ($z = 0; $z < count($srchInsArrys); $z++) {
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label for="hotlChckinDocSpnsee" class="control-label col-md-4">Occupant:</label>
                                    <div  class="col-md-8"> 
                                        <div class="input-group" style="width:100% !important;">
                                ...
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <label style="margin-bottom:0px !important;">Adults/Children:</label>
                                    </div>
                                    <div class="col-md-4" style="padding:0px 1px 0px 15px;">
                                        <input type="number" class="form-control" aria-label="..." id="hotlChckinDocNoAdlts" name="hotlChckinDocNoAdlts" value="<?php echo $hotlChckinDocNoAdlts; ?>" <?php echo $mkRmrkReadOnly; ?> title="Number of Adults">
                                    </div>
                                    <div class="col-md-4" style="padding:0px 15px 0px 1px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <span  class="btn btn-default" style="white-space: normal !important;word-wrap:break-word !important; color:<?php echo $rqstatusColor; ?>;font-weight: bold;height:34px;font-size:11px;width:100% !important;" id="myScmSalesInvcStatusBtn">
                                            <?php
                                            echo str_replace(" [" . $rqStatus . "]", "",
                                                    $rqStatus . ($scmSalesInvcIsPstd == "1" ? " [Posted]" : " [Not Posted]") . " [" . $hotlChckinDocStatus . "]");
                                            ?>
                                        </span>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="col-md-4" style="padding:0px 0px 0px 0px !important;">
                                                        <div class="" style="padding:0px 0px 0px 0px;float:right !important;"> 
                                                            ...
                                                            if ($rqStatus == "Not Validated") {
                                                                ?>
                                                                <?php if ($canEdt) { ?>
                                                                    <button type="button" class="btn btn-default" style="margin-bottom: 1px;height:30px;" onclick="saveHotlChckinDocForm('<?php echo $fnccurnm; ?>', 0, 'NORMAL', 'CHECK-IN', '<?php echo $srcModule; ?>');"><img src="cmn_images/FloppyDisk.png" style="left: 0.5%; padding-right: 5px; height:17px; width:auto; position: relative; vertical-align: middle;">Save&nbsp;</button>    
                                                                <?php } ?>
                                                                <?php if ($canRvwApprvDocs) { ?>
                                                                    <button type="button" class="btn btn-default" style="margin-bottom: 1px;height:30px;" onclick="saveHotlChckinDocForm('<?php echo $fnccurnm; ?>', 2, 'NORMAL', 'CHECK-IN', '<?php echo $srcModule; ?>');" data-toggle="tooltip" data-placement="bottom" title="Finalize Document">
