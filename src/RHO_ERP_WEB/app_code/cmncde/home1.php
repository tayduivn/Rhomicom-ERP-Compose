...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="row" style="padding:1px 1px 0px 1px;margin: -1px -15px 0px -15px;">
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">
                <?php if ($canViewSelfsrvc) { ?>
                    <div class="panel" style="color:white;background-color:#5cb85c;border-radius:5px;border:1px solid #5cb85c;">
                            ...
                            <div class="panel-heading" style="color:white;background-color:#5cb85c;border-radius:5px;border:1px solid #5cb85c;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Personal Records</div>
                                    </div>
                                </div>
                            </div>
                ...
                <?php } else { ?>
                    <div class="panel" style="color:<?php echo $bckcolorOnly1; ?>;background-color:white;border-radius:5px;border:1px solid <?php echo $bckcolorOnly1; ?>;">
                            ...
                            <div class="panel-heading" style="color:<?php echo $bckcolorOnly1; ?>;background-color:white;border-radius:5px;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">No Access</div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">                             
                <?php if ($canViewIntrnlPay) { ?>
                    <div class="panel panel-default" style="color:white;background-color:#d9534f;border-radius:5px;border:1px solid #d9534f;">
                        <a href="javascript:openATab('#allmodules', 'grp=7&typ=1');">
                            <div class="panel-heading" style="color:white;background-color:#d9534f;border-radius:5px;border:1px solid #d9534f;">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="cmn_images/invcBill.png" style="margin:1px; padding-right: 1em; height:58px; width:auto; position: relative; vertical-align: middle;float:left;">
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">13</div>
                                        <div style="font-weight:bold;">Bills/Payments</div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">
                <?php if ($canViewSales) { ?>
                    <div class="panel panel-default" style="color:white;background-color:#337ab7;border-radius:5px;border:1px solid #337ab7;" >
                            ...
                            <div class="panel-heading" style="color:white;background-color:#337ab7;border-radius:5px;border:1px solid #337ab7;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Sales and Inventory</div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">                              
                <?php if ($canViewAcntng) { ?>
                    <div class="panel panel-default" style="color:white;background-color:#5cb85c;border-radius:5px;border:1px solid #5cb85c;">
        ...
        <div class="row" style="padding:1px 1px 0px 1px;margin: -1px -15px 0px -15px;">
                            ...
                            <div class="panel-heading" style="color:white;background-color:#337ab7;border-radius:5px;border:1px solid #337ab7;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Banking</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#337ab7;border-top:1px solid #337ab7;">
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">                
                <?php if ($canViewVMS) { ?>
                    <div class="panel panel-default" style="color:black;background-color:white;border-radius:5px;border:1px solid #f0ad4e;">
                            ...
                            <div class="panel-heading" style="color:black;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Vault Management</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-heading" style="color:white;background-color:#d9534f;border-radius:5px;border:1px solid #d9534f;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">13</div>
                                        <div style="font-weight:bold;">Events/Attendance</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#d9534f;border-top:1px solid #d9534f;">
                            ...
                            <div class="panel-heading" style="color:white;background-color:#337ab7;border-radius:5px;border:1px solid #337ab7;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Rentals/Hospitality</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#337ab7;border-top:1px solid #337ab7;">
        ...
        <div class="row" style="padding:1px 1px 0px 1px;margin: -1px -15px 0px -15px;">
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">                
                <?php if ($canViewPrfmnc) { ?>
                    <div class="panel panel-default" style="color:white;background-color:white;border-radius:5px;border:1px solid #5cb85c;">
                        <a href="javascript:openATab('#allmodules', 'grp=15&typ=1');">
                            <div class="panel-heading" style="color:black;">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="cmn_images/education.png" style="margin:1px; padding-right: 1em; height:58px; width:auto; position: relative; vertical-align: middle;float:left;">
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Performance Management</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#5cb85c;border-top:1px solid #5cb85c;">
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">                
                <?php if ($canViewProjs) { ?>
                    <div class="panel panel-default" style="color:white;background-color:#d9534f;border-radius:5px;border:1px solid #d9534f;">
                        <a href="javascript:openATab('#allmodules', 'grp=13&typ=1');">
                            <div class="panel-heading" style="color:white;background-color:#d9534f;border-radius:5px;border:1px solid #d9534f;">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="cmn_images/engineer.png" style="margin:1px; padding-right: 1em; height:58px; width:auto; position: relative; vertical-align: middle;float:left;">
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Projects Management</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#d9534f;border-top:1px solid #d9534f;">
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">                
                <?php if ($canViewVsts) { ?>
                    <div class="panel panel-default" style="color:white;background-color:#f0ad4e;border-radius:5px;border:1px solid #f0ad4e;">
                            ...
                            <div class="panel-heading" style="color:white;background-color:#f0ad4e;border-radius:5px;border:1px solid #f0ad4e;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Visits and Appointments</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#f0ad4e;border-top:1px solid #f0ad4e;">
                            ...
                            <div class="panel-heading" style="color:white;background-color:#d9534f;border-radius:5px;border:1px solid #d9534f;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Clinic/Hospital</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#d9534f;border-top:1px solid #d9534f;">
        ...
        <div class="row" style="padding:1px 1px 0px 1px;margin: -1px -15px 0px -15px;">
                    ...
                    <div class="panel panel-default" style="color:white;background-color:#f0ad4e;border-radius:5px;border:1px solid #f0ad4e;">
                        <a href="javascript:openATab('#allmodules', 'grp=19&typ=10');">
                            <div class="panel-heading" style="color:white;background-color:#f0ad4e;border-radius:5px;border:1px solid #f0ad4e;">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="cmn_images/election.png" style="margin:1px; padding-right: 1em; height:58px; width:auto; position: relative; vertical-align: middle;float:left;">
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Elections Centre</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#f0ad4e;border-top:1px solid #f0ad4e;">
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">                
                <?php if ($canViewElearn) { ?>
                    <div class="panel panel-default" style="color:white;background-color:#f0ad4e;border-radius:5px;border:1px solid #f0ad4e;">
                        <a href="javascript:openATab('#allmodules', 'grp=19&typ=12');">
                            <div class="panel-heading" style="color:white;background-color:#f0ad4e;border-radius:5px;border:1px solid #f0ad4e;">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="cmn_images/addresses_wbg_64x64.png" style="margin:1px; padding-right: 1em; height:58px; width:auto; position: relative; vertical-align: middle;float:left;">
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">e-Learning/e-Library</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#f0ad4e;border-top:1px solid #f0ad4e;">
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">                
                <?php if ($canViewLov) { ?>
                    <div class="panel panel-default" style="color:white;background-color:#d9534f;border-radius:5px;border:1px solid #d9534f;">
                        <a href="javascript:openATab('#allmodules', 'grp=4&typ=1');">
                            <div class="panel-heading" style="color:white;background-color:#d9534f;border-radius:5px;border:1px solid #d9534f;">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="cmn_images/viewIcon.png" style="margin:1px; padding-right: 1em; height:58px; width:auto; position: relative; vertical-align: middle;float:left;">
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Value Lists Setup</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#d9534f;border-top:1px solid #d9534f;">
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">
                <?php if ($canViewSysAdmin) { ?>
                    <div class="panel" style="color:white;background-color:#5cb85c;border-radius:5px;border:1px solid #5cb85c;">
                        <a href="javascript:openATab('#allmodules', 'grp=3&typ=1');">
                            <div class="panel-heading" style="color:white;background-color:#5cb85c;border-radius:5px;border:1px solid #5cb85c;">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="cmn_images/ma-logo.png" style="margin:1px; padding-right: 1em; height:58px; width:auto; position: relative; vertical-align: middle;float:left;">
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">System Administration</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#5cb85c;border-top:1px solid #5cb85c;">
        ...
        <div class="row" style="padding:1px 1px 0px 1px;margin: -1px -15px 0px -15px;">
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">                              
                <?php if ($canViewRpts) { ?>
                    <div class="panel panel-default" style="color:black;background-color:white;border-radius:5px;border:1px solid #5cb85c;">
                            ...
                            <div class="panel-heading" style="color:black;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Reports and Processes</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#5cb85c;border-top:1px solid #5cb85c;">
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">
                <?php if (true) { ?>
                    <div class="panel panel-default" style="color:black;border-radius:5px;border:1px solid #337ab7;" >
                        <a href="javascript:openATab('#allmodules', 'grp=41&typ=1');">
                            <div class="panel-heading" style="color:black;">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="cmn_images/helpdesk1.png" style="margin:1px; padding-right: 1em; height:58px; width:auto; position: relative; vertical-align: middle;float:left;">
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Help Desk</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#337ab7;border-top:1px solid #337ab7;">
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">
                <?php if (true) { ?>
                    <div class="panel panel-default" style="color:black;border-radius:5px;border:1px solid #f0ad4e;">
                            ...
                            <div class="panel-heading" style="color:black;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&nbsp;</div>
                                        <div class="huge">&nbsp;</div>
                                        <div style="font-weight:bold;">Summary Dashboard</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer" style="color:white;background-color:#f0ad4e;border-top:1px solid #f0ad4e;">
            ...
            <div class="col-lg-3" style="padding:0px 13px 0px 15px;">
                <div class="panel panel-default" style="color:black;border-radius:5px;border:1px solid #d9534f;">
                    <a href="javascript:openATab('#allmodules', 'grp=40&typ=5');">
                        <div class="panel-heading" style="color:black;">
                            <div class="row">
                                <div class="col-xs-3">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">&nbsp;</div>
                                    <div class="huge">&nbsp;</div>
                                    <div style="font-weight:bold;">All Apps/Modules</div>
                                </div>
                            </div>
                        </div>
                        <div class="panel-footer" style="color:white;background-color:#d9534f;border-top:1px solid #d9534f;">
