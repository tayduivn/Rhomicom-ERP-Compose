        ...
        if ($subPgNo == 7.1) {//SAVINGS PRODUCT
            if ($vwtyp == "0") {
                ...
                ?>
                            ...
                            <div class="row svngsDiv"><!-- ROW 4 svngsDiv-->
                                <div class="col-lg-12"> 
                                    <fieldset class="basic_person_fs3"> <legend class="basic_person_lg1">Withdrawal</legend> 
                                        <div class="row" style="margin:5px !important;text-align: centre !important;"><!--subrow 1-->
                                            <div  class="col-lg-6">                                                            
                                                <div class="form-group form-group-sm">
                                                    <label for="smsAlertFee" class="control-label col-md-4">SMS Alert Fee:</label>
                                                    <div  class="col-md-8">
                                                        <input class="form-control" id="smsAlertFee" type = "number" min="0" placeholder="SMS Alert Fee" value="0.00"/>
                                                    </div>
                                                </div>                                                                
                                            </div>
                                            <div  class="col-lg-6">
                                                <div class="form-group form-group-sm">
                                                    <label for="smsAlertFeeRvnueAcct" class="control-label col-md-4">Revenue Account:</label>
                                                    <div  class="col-md-8">
                                                        <div class="input-group">
                                                            <input <?php echo $mkReadOnly; ?> type="text" class="form-control" aria-label="..." id="smsAlertFeeRvnueAcct" value="">
                                                            <input type="hidden" id="gnrlOrgID" value="<?php echo $orgID; ?>">
                                                            <input type="hidden" id="smsAlertFeeRvnueAcctID" value="-1">
                                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '', 'smsAlertFeeRvnueAcctID', 'smsAlertFeeRvnueAcct', 'clear', 1, ' AND (SELECT is_prnt_accnt FROM accb.accb_chart_of_accnts x WHERE x.accnt_id = tbl1.a::bigint AND accnt_type = \'R\') = \'0\' ');">
                ...
                while ($row = loc_db_fetch_array($result)) {
                    ...
                    <?php } ?>
                            ...
                            <div class="" style="float:right;">
                    <?php if ($vwtypActn == "EDIT") {
                        if ($trnsStatus == "Authorized" || $trnsStatus == "Approved" && (test_prmssns($dfltPrvldgs[65], $mdlNm) === true)) { ?>
                    ...
                    <?php } ?>																			
                                                    ...
                                                    <div class="row svngsDiv"><!-- ROW 4 -->
                                                        <div class="col-lg-12"> 
                                                            <fieldset class="basic_person_fs5"> <legend class="basic_person_lg1">SMS Alert</legend> 
                                                                <div class="row" style="margin:5px !important;text-align: centre !important;"><!--subrow 1-->
                                                                    <div  class="col-lg-6">                                                            
                                                                        <div class="form-group form-group-sm">
                                                                            <?php echo dsplyCntrlLbl($cnt, $row[46], $rowATZ46, "col-md-4", "SMS Alert Fee", "smsAlertFee"); ?>
                                                                            <div  class="col-md-8">
                                                                                <input <?php echo $mkReadOnly; ?> class="form-control" id="smsAlertFee" type = "number" min="0" placeholder="SMS Alert Fee" value="<?php echo $row[46]; ?>"/>
                                                                            </div>
                                                                        </div>                                                                
                                                                    </div>
                                                                    <div  class="col-lg-6">
                                                                        <div class="form-group form-group-sm">
                                                                            <?php
                                                                            $rwDt47 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row[47]);
                                                                            echo dsplyCntrlLbl($cnt, $rwDt47, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ47), "col-md-4", "Revenue Account", "smsAlertFeeRvnueAcct");
                                                                            ?>
                                                                            <div  class="col-md-8">
                                                                                <div class="input-group">
                                                                                    <input <?php echo $mkReadOnly; ?> type="text" class="form-control" aria-label="..." id="smsAlertFeeRvnueAcct" value="<?php echo $rwDt47; ?>">
                                                                                    <input type="hidden" id="gnrlOrgID" value="<?php echo $orgID; ?>">
                                                                                    <input type="hidden" id="smsAlertFeeRvnueAcctID" value="<?php echo $row[47]; ?>">
                                                                                    <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Accounts', 'gnrlOrgID', '', '', 'radio', true, '<?php echo ""; ?>', 'smsAlertFeeRvnueAcctID', 'smsAlertFeeRvnueAcct', 'clear', 1, ' AND (SELECT is_prnt_accnt FROM accb.accb_chart_of_accnts x WHERE x.accnt_id = tbl1.a::bigint AND accnt_type = \'R\') = \'0\' ');">
                                                                                        <span class="glyphicon glyphicon-th-list"></span>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
            ...
            if ($vwtypActn === "ADD_NA") {
                ...
                <form class="form-horizontal" id='stdEvntsForm' action='' method='post' accept-charset='UTF-8'>
                        ...
                        <div class="row"><!-- ROW 1 -->
                            <div class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Cash Deposit</legend>
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt1 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[1]);
                    ...
                    ?>
                                    ...
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt2 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[2]);
                    echo dsplyCntrlLbl($cnt, $rwDt2, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ2), "col-md-4", "Credit Account", "cashDepositCrdtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                            ...
                            <div class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Cheque Deposit</legend>
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt3 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[3]);
                    echo dsplyCntrlLbl($cnt, $rwDt3, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ3), "col-md-4", "Debit Account", "chqDepositDbtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt4 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[4]);
                    echo dsplyCntrlLbl($cnt, $rwDt4, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ4), "col-md-4", "Credit Account", "chqDepositCrdtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                            ...
                            <div <?php echo $showHideDivSvngsAccts; ?> class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Cash Withdrawal</legend>
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt5 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[5]);
                    echo dsplyCntrlLbl($cnt, $rwDt5, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ5), "col-md-4", "Debit Account", "cashWtdwlDbtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt6 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[6]);
                    echo dsplyCntrlLbl($cnt, $rwDt6, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ6), "col-md-4", "Credit Account", "cashWtdwlCrdtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                        ...
                        <div <?php echo $showHideDivSvngsAccts; ?> class="row"><!-- ROW 2 -->
                            <div class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Entry Fees</legend>
                                    <div class="form-group form-group-sm">
                                                <?php
                                                       $rwDt7 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[7]);
                                                       echo dsplyCntrlLbl($cnt, $rwDt7, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ7), "col-md-4", "Debit Account", "entryFeesDbtAcc");
                                                       ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt8 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[8]);
                    echo dsplyCntrlLbl($cnt, $rwDt8, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ8), "col-md-4", "Credit Account", "entryFeesCrdtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                            ...
                            <div class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Close Fees</legend>
                                    <div class="form-group form-group-sm">
                                                <?php
                                                $rwDt9 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[9]);
                                                echo dsplyCntrlLbl($cnt, $rwDt9, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ9), "col-md-4", "Debit Account", "closeFeesDbtAcc");
                                                ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                                        <?php
                                        $rwDt10 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[10]);
                                        echo dsplyCntrlLbl($cnt, $rwDt10, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ10), "col-md-4", "Credit Account", "closeFeesCrdtAcc");
                                        ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                            ...
                            <div class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Re-Open Fees</legend>
                                    <div class="form-group form-group-sm">
                                        <?php
                                        $rwDt11 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[11]);
                                        echo dsplyCntrlLbl($cnt, $rwDt11, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ11), "col-md-4", "Debit Account", "reopenFeesDbtAcc");
                                        ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt12 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[12]);
                    echo dsplyCntrlLbl($cnt, $rwDt12, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ12), "col-md-4", "Credit Account", "reopenFeesCrdtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                        ...
                        <div class="row"><!-- ROW 3 -->
                            <div <?php echo $showHideDivSvngsAccts; ?> class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Overdraft Penalty Fee</legend>
                                    <div class="form-group form-group-sm">
                                        <?php
                                        $rwDt13 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[13]);
                                        echo dsplyCntrlLbl($cnt, $rwDt13, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ13), "col-md-4", "Debit Account", "wtdwlPnltyFlatDbtAcc");
                                        ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                                                <?php
                                                $rwDt14 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[14]);
                                                echo dsplyCntrlLbl($cnt, $rwDt14, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ14), "col-md-4", "Credit Account", "wtdwlPnltyFlatCrdtAcc");
                                                ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                            ...
                            <div <?php echo $showHideDivSvngsAccts; ?> class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Commission on Turnover</legend>
                                    <div class="form-group form-group-sm">
                                        <?php
                                        $rwDt17 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[17]);
                                        echo dsplyCntrlLbl($cnt, $rwDt17, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ17), "col-md-4", "Debit Account", "cotFeeFlatDbtAcc");
                                        ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt18 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[18]);
                    echo dsplyCntrlLbl($cnt, $rwDt18, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ18), "col-md-4", "Credit Account", "cotFeeFlatCrdtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                            ...
                            <div class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Interest Accrual</legend>
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt21 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[21]);
                    echo dsplyCntrlLbl($cnt, $rwDt21, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ21), "col-md-4", "Debit Account", "interesPyblDbtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt22 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[22]);
                    echo dsplyCntrlLbl($cnt, $rwDt22, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ22), "col-md-4", "Credit Account", "interesPyblCrdtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                        ...
                        <div class="row"><!-- ROW 4 -->
                            <div class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Interest Payment</legend>
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt23 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[23]);
                    echo dsplyCntrlLbl($cnt, $rwDt23, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ23), "col-md-4", "Debit Account", "interesExpenseDbtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt24 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[24]);
                    echo dsplyCntrlLbl($cnt, $rwDt24, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ24), "col-md-4", "Credit Account", "interesExpenseCrdtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                            ...
                            <div <?php echo $showHideDivInvstmntAccts; ?> class="col-lg-4">
                                <fieldset class="basic_person_fs5"><legend class="basic_person_lg">Investment</legend>
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt19 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[19]);
                    echo dsplyCntrlLbl($cnt, $rwDt19, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ19), "col-md-4", "Liability Account", "invstmntFeeDbtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt20 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[20]);
                    echo dsplyCntrlLbl($cnt, $rwDt20, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ20), "col-md-4", "Fee Revenue Account", "invstmntFeeCrdtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <fieldset style="display:none !important;" class="basic_person_fs5"><legend class="basic_person_lg">Withdrawal Penalty Fee (%)</legend>
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt15 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[15]);
                    echo dsplyCntrlLbl($cnt, $rwDt15, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ15), "col-md-4", "Debit Account", "wtdwlPnltyPrcntDbtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group form-group-sm">
                    <?php
                    $rwDt16 = getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $row2[16]);
                    echo dsplyCntrlLbl($cnt, $rwDt16, getGnrlRecNm("accb.accb_chart_of_accnts", "accnt_id", "accnt_num || '.' || accnt_name", $rowATZ16), "col-md-4", "Credit Account", "wtdwlPnltyPrcntCrdtAcc");
                    ?>
                                        <div  class="col-md-8">
                                            <div class="input-group">
        ...
        if ($vwtyp == "0") {
            if ($vwtypActn == "EDIT" || $vwtypActn == "VIEW" || $vwtypActn == "ADD") {
                ...
                if ($cnt > 0) {
                    ...
                    while ($rowATZ = loc_db_fetch_array($resultAuthrzd)) {
                        $loan_product_idATZ = $rowATZ[0];
                        $product_nameATZ = $rowATZ[1];
                        $product_descATZ = $rowATZ[2];
                        $product_codeATZ = $rowATZ[3];
                        $loan_max_amountATZ = $rowATZ[4];
                        $loan_min_amountATZ = $rowATZ[5];
                        $loan_repayment_typeATZ = $rowATZ[6];
                        $grace_period_noATZ = $rowATZ[7];
                        $grace_period_typeATZ = $rowATZ[8];
                        $max_loan_tenorATZ = $rowATZ[9];
                        $max_loan_tenor_typeATZ = $rowATZ[10];
                        $guarantor_requiredATZ = $rowATZ[11];
                        $guarantor_noATZ = $rowATZ[12];
                        ...
                        $currency_id_oldATZ = $rowATZ[15];
                        $product_typeATZ = $rowATZ[16];
                        $posting_frequencyATZ = $rowATZ[17];
                        $charge_interestATZ = $rowATZ[18];
                        $interest_rateATZ = $rowATZ[19];
                        $cust_type_custgrpATZ = $rowATZ[20];
                        $cust_type_corpATZ = $rowATZ[21];
                        $cust_type_indATZ = $rowATZ[22];
                        $start_date_activeATZ = $rowATZ[23];
                        $end_date_activeATZ = $rowATZ[24];
                        $compounding_periodATZ = $rowATZ[25];
                        $principal_rcvbl_acct_idATZ = $rowATZ[26];
                        $interest_rcvbl_acct_idATZ = $rowATZ[27];
                        $deferred_interest_acct_idATZ = $rowATZ[28];
                        $loans_payable_acct_idATZ = $rowATZ[29];
                        $is_account_rqrdATZ = $rowATZ[30];
                        $cash_collateral_rqrdATZ = $rowATZ[31];
                        $value_flat_min_cash_collateralATZ = $rowATZ[32];
                        $value_flat_prcnt_cash_collateralATZ = $rowATZ[33];
                        $prpty_collateral_rqrdATZ = $rowATZ[34];
                        $value_flat_min_prpty_collateralATZ = $rowATZ[35];
                        $value_flat_prcnt_prpty_collateralATZ = $rowATZ[36];
                        $invstmnt_collateral_rqrdATZ = $rowATZ[37];
                        $value_flat_min_invstmnt_collateralATZ = $rowATZ[38];
                        $value_flat_prcnt_invstmnt_collateralATZ = $rowATZ[39];
                        $min_loan_tenorATZ = $rowATZ[40];
                        $min_loan_tenor_typeATZ = $rowATZ[41];
                        $rcvry_officer_rqrdATZ = $rowATZ[42];
                        $currency_idATZ = $rowATZ[43];
                        $interest_rate_typeATZ = $rowATZ[44];
                        $interest_revenue_acct_idATZ = $rowATZ[45];
                        $ttl_allwd_principal_rcvbl_amnt_flatATZ = $rowATZ[46];
                        $scoring_set_hdr_idATZ = $rowATZ[47];
                ...
                <div class="">
                    <div class="row" style="margin: 0px 0px 10px 0px !important;">
                        <div class="col-md-12" style="padding:0px 1px 5px 1px !important;">
                            ...
                            <div class="" style="float:right;">
                <?php if ($vwtypActn == "EDIT" || $vwtypActn == "ADD") {
                    if ($trnsStatus == "Authorized") { ?>
                                                    ...
                                                    while ($row2 = loc_db_fetch_array($result2)) {
                                                        ...
                                                        ?>
                                                                    <tr id="allPrcsnFeesRow_<?php echo $cntr; ?>">                                    
                                                                       ...
                                                                       <?php
                                                                       if ($vwtypActn === "VIEW" || $trnsStatus === "Initiated" || $trnsStatus === "Unauthorized") {
                            ...
                            ?>
                                                                ...
                                                                if ($vwtypActn === "VIEW" || $trnsStatus === "Initiated" || $trnsStatus === "Unauthorized") {
                                                                    ...
                                                                    <?php } ?>
                                                                        ...
                                                                        <td class="lovtd">
                                                                    <?php
                                                                    if ($vwtypActn === "VIEW" || $trnsStatus === "Initiated" || $trnsStatus === "Unauthorized" || $trnsStatus == "Approved") {
