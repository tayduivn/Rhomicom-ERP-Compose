...
$canAdd = test_prmssns($dfltPrvldgs2[9], $mdlNm);
$canEdt = test_prmssns($dfltPrvldgs2[10], $mdlNm);
$canDel = test_prmssns($dfltPrvldgs2[11], $mdlNm);
    ...
    if ($lgn_num > 0 && $canview === true) {
        if ($qstr == "DELETE") {
            ...
            if ($actyp == 1) {
                ...
                $sbmtdPayDocTyp = isset($_POST['sbmtdPayDocTyp']) ? cleanInputData($_POST['sbmtdPayDocTyp']) : "INVESTMENT";
                $payTransType = $sbmtdPayDocTyp;
                if (!($canEdt || $canAdd)) {
                    $arr_content['percent'] = 100;
            ...
            if ($vwtyp == 0) {
                            ...
                            <div class="row" style="margin-bottom:0px;">
                                ...
                                <div class="<?php echo $colClassType2; ?>" style="padding:0px 15px 0px 15px !important;">
                                    <div class="input-group">
                                        ...
                                        ?>" onkeyup="enterKeyFuncPayInvstTrans(event, '', '#allmodules', 'grp=6&typ=1&pg=<?php echo $pgNo; ?>&vtyp=0');">
                                        <input id="payInvstTransPageNo" type = "hidden" value="<?php echo $pageNo; ?>">
                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getPayInvstTrans('clear', '#allmodules', 'grp=6&typ=1&pg=<?php echo $pgNo; ?>&vtyp=0');">
                                            <span class="glyphicon glyphicon-remove"></span>
                                        </label>
                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getPayInvstTrans('', '#allmodules', 'grp=6&typ=1&pg=<?php echo $pgNo; ?>&vtyp=0');">
                                ...
                                <div class="<?php echo $colClassType1; ?>">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination" style="margin: 0px !important;">
                                            <li>
                                                <a href="javascript:getPayInvstTrans('previous', '#allmodules', 'grp=6&typ=1&pg=<?php echo $pgNo; ?>&vtyp=0');" aria-label="Previous">
                                                    <span aria-hidden="true">&laquo;</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="javascript:getPayInvstTrans('next', '#allmodules', 'grp=6&typ=1&pg=<?php echo $pgNo; ?>&vtyp=0');" aria-label="Next">
                ...
                $pkID = $sbmtdPayInvstTransID;
                $total = get_Total_InvstTrans_Attachments($srchFor, $pkID, $sbmtdPayDocTyp);
                if ($pageNo > ceil($total / $lmtSze)) {
                    $pageNo = 1;
                } else if ($pageNo < 1) {
                    $pageNo = ceil($total / $lmtSze);
                ...
                $curIdx = $pageNo - 1;
                $attchSQL = "";
                $result2 = get_InvstTrans_Attachments($srchFor, $curIdx, $lmtSze, $pkID, $sbmtdPayDocTyp, $attchSQL);
