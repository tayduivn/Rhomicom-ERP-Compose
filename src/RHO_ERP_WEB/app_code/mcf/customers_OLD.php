        ...
        if ($subPgNo == 1.1) {
            ...
            echo $cntent .= "
					<li onclick=\"openATab('#allmodules', 'grp=17&typ=1&pg=1&subPgNo=1.2');\">
                                                <span class=\"divider\"><i class=\"fa fa-angle-right\" aria-hidden=\"true\"></i></span>
						<span style=\"text-decoration:none;\">Corporate Customers</span>
                                        </li></div>";
            $error = "";
            $searchAll = true;
                ...
                <form id='mcfCorpCstmrForm' action='' method='post' accept-charset='UTF-8'>
                    <div class="row" style="margin-bottom:1px;">
                        <?php if ($canAddCorpCstmr === true) { ?>   
                            <div class="<?php echo $colClassType1; ?>" style="padding:0px 1px 0px 15px !important;">                    
                                <button type="button" class="btn btn-default" style="margin-bottom: 5px;" onclick="getCustomersForm('myFormsModalLg', 'myFormsModalBodyLg', 'myFormsModalTitleLg', 'Add New Corporate Customer', 11, <?php echo $subPgNo; ?>, 0, 'ADD', -1);">
                                    <img src="cmn_images/add1-64.png" style="left: 0.5%; padding-right: 5px; height:20px; width:auto; position: relative; vertical-align: middle;">
                                    New Customer
                                </button>
                            </div>
