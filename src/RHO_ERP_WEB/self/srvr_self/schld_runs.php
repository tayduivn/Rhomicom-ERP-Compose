...
$mdlNm = "Self Service";
$canRunRpts = true;
//test_prmssns($dfltPrvldgs[8], $mdlNm);
$canDelRptRuns = false; // test_prmssns($dfltPrvldgs[9], $mdlNm);
$canVwOthrsRuns = false; //test_prmssns($dfltPrvldgs[10], $mdlNm);
$canview = true;
                    ...
                    <div class="row" style="padding:0px 15px 0px 15px !important;"> 
                        <div  class="col-lg-4" style="padding:0px 1px 0px 1px !important">
                            <fieldset class="basic_person_fs">                                        
                                <table class="table table-striped table-bordered" id="allSchdlsTable" cellspacing="0" width="100%" style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Scheduled By</th>
                            ...
                            <div class="rho-container-fluid" id="allSchdlsDetailInfo">
                                ...
                                if ($pkID > 0) {
                                    ...
                                    while ($row1 = loc_db_fetch_array($result1)) {
                                        ...
                                        <div class="row">   
                                            <div  class="col-lg-12" 
                                                  <table class="table table-striped table-bordered" id="allSchdlPrmsTable" cellspacing="0" width="100%" style="width:100%;min-width: 330px;">
                                                    <thead>
                                                        <tr>
                                                            <th>No.</th>
