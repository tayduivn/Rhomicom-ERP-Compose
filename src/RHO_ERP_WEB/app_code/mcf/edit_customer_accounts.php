...
if (array_key_exists('lgn_num', get_defined_vars())) {
    ...
    $canMdfyCstmrAcctNumber = test_prmssns($dfltPrvldgs[299], $mdlNm);

    $rowATZ0 = ""; $rowATZ1 = ""; $rowATZ2 = "";$rowATZ3 = "";$rowATZ4 = "";$rowATZ5 = "";$rowATZ6 = "";$rowATZ7 = "";$rowATZ8 = "";$rowATZ9 = "";$rowATZ10 = "";
    $rowATZ11 = "";$rowATZ12 = "";$rowATZ13 = "";$rowATZ14 = "";$rowATZ15 = "";$rowATZ16 = "";$rowATZ17 = "";$rowATZ18 = "";$rowATZ19 = "";
    ...
    if ($subPgNo == 2.1) {//CUSTOMER ACCOUNTS
        if ($vwtyp == "0") {
		    ...
		    $accntCtgry = $row[35];
                    ...
                    $mkReadOnly = "";
                    $mkReadOnlyDsbld = "";
                    $mkReadOnlyAcctNmbr =  "readonly=\"readonly\"";
		    ...
		    if($trnsStatus == "Initiated" || $trnsStatus == "Approved" || $trnsStatus == "Unauthorized" || $trnsStatus == "Authorized"){
                    ...
                    <div class="">
                        <div class="row">                  
							...
							<button type="button" class="btn btn-default btn-sm" style="height:30px;" id="myVmsTrnsStatusBtn">
                                                            <span style="font-weight:bold;">Category: </span><span style="color:<?php echo "blue"; ?>;font-weight: bold;"><?php echo $accntCtgry; ?></span>
                                                        </button>							
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <fieldset class="basic_person_fs1" style="margin-top: 5px !important;"><legend class="basic_person_lg">Account</legend>
                                                            <div class="form-group form-group-sm">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control" id="acctNumber" type = "text" placeholder="" value="<?php echo $row[4]; ?>" <?php echo $mkReadOnlyAcctNmbr; ?> <?php echo $mkReadOnly; ?>/>
                                                                    <!--CUSTOMER ID-->
                                                    ...
                                                    <div class="col-lg-6">
                                                        <fieldset class="basic_person_fs1" style="margin-top: 5px !important;"><legend class="basic_person_lg">General</legend>
                                                            ...
                                                            <div class="form-group form-group-sm">
                                                                ...
                                                                <div  class="col-md-8">
                                                                    <textarea <?php echo $mkReadOnly; ?> class="form-control" id="srcOfFundsOther" cols="2" placeholder="Source of Funds - Other" rows="1"><?php echo $row[16]; ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group form-group-sm">
                                                                <?php if($cnt > 0 && $row[34] != $rowATZ34) { ?>
                                                                <label data-toggle="tooltip" title="<?php echo $rowATZ34; ?>" for="smsTriggers" id="smsTriggersLbl" class="control-label col-md-4"><a href="#" style="color:red;" onclick="dsplyAuthrzdData('<?php echo $rowATZ34; ?>');">SMS Alert Triggers:</a></label>
                                                                <?php } else { ?>
                                                                <label for="smsTriggers" id="smsTriggersLbl" class="control-label col-md-4">SMS Alert Triggers:</label>
                                                                <?php } ?>
                                                                <div class="col-md-8">
                                                                    <select class="form-control" name="smsTriggers" id="smsTriggers" multiple>
                                                                        <!--<option value="">&nbsp;</option>-->
                                                                            <?php
                                                                            $brghtStr = "";
                                                                            $isDynmyc = FALSE;
                                                                            $titleRslt = getLovValues("%", "Both", 0, 100, $brghtStr, getLovID("MCF SMS Triggers"), $isDynmyc, -1, "", "");
                                                                            while ($titleRow = loc_db_fetch_array($titleRslt)) {
                                                                                $selectedTxt = "";
                                                                                $srcOfFundsArr = explode(',', $row[34]);
                                                                                foreach ($srcOfFundsArr as $val) {
                                                                                    if ($val == $titleRow[0]) {
                                                                                        $selectedTxt = "selected=\"selected\"";
                                                                                    }
                                                            ...
                                                            <table id="acctLiensTblAdd" class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%" style="width:100%;">
                                                                ...
                                                                <tbody>
                                                                        ...
                                                                        <tr id="acctLiensTblAddRow<?php echo $row2[0]; ?>">
                                                                            <?php if($trnsStatus == "Incomplete" || $trnsStatus == "Rejected" || $trnsStatus == "Withdrawn"){ if(test_prmssns($dfltPrvldgs[88], $mdlNm) === true) { ?>
                                                                            <td class="lovtd">
                                                                                <?php if(/*(int)$row2[10] <= 0 || $row2[6] == "Removed"*/ 1 == 1) { ?>
                                                                             ...
                                                                             <?php } if(test_prmssns($dfltPrvldgs[89], $mdlNm) === true) { ?>    
                                                                            <td class="lovtd">
                                                                                <?php if(/*(int)$row2[10] <= 0  ||*/ $row2[6] == "Inactive") { ?>
                ...
                ?>
                                                        ...
                                                        <div class="form-group form-group-sm">
                                                            ...
                                                            <div  class="col-md-8">
                                                                <textarea class="form-control" id="srcOfFundsOther" cols="2" placeholder="Source of Funds - Other" rows="1"></textarea>
                                                            </div>
                                                        </div> 
                                                        <div class="form-group form-group-sm">
                                                            <label for="smsTriggers" id="smsTriggersLbl" class="control-label col-md-4">SMS Alert Triggers:</label>
