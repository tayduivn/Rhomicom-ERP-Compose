        ...
        if ($qstr == "DELETE") {
            ...
            if ($actyp == 1) {
                ...
                if ($hotlChckinDocOthrInfo == "") {
                    $hotlChckinDocOthrInfo = $hotlChckinDocSrvcTyp . " (REC. AGAINST:" . $hotlChckinDocSpnsee . " from " .
                ...
                } else if ($hotlChckinDocVchType == "Booking") {
                ...
                if ($hotlChckinDocSrvcTypID <= 0) {
                    $exitErrMsg .= "Linked Event cannot be empty!<br/>";
                }
                if ($hotlChckinDocRmID <= 0) {
                    $exitErrMsg .= "Price Category cannot be empty!<br/>";
                }
                if ($hotlChckinDocSpnseeID <= 0 || $hotlChckinDocSpnsrID <= 0) {
                    $exitErrMsg .= "Sponsor and Participant cannot be empty!<br/>";
                }
                ...
                if (trim($slctdDetTransLines, "|~") != "") {
                    ...
                    for ($y = 0; $y < count($variousRows); $y++) {
                        ...
                        if (count($crntRow) == 18) {
                            ...
                            //echo cleanInputData1($crntRow[17])."::".$ln_IsDlvrd;
                ...
                if ($sbmtdHotlChckinDocID > 0 && $hotlChckinDocSrvcTypID > 0 && $sbmtdScmSalesInvcID > 0 && $hotlChckinDocRmID > 0) {
                    $mainItemID = (int) getGnrlRecNm("attn.event_price_categories", "price_ctgry_id", "inv_itm_id", $hotlChckinDocRmID);
                    ...
                    if ($sbmtdHotlChckinDocID > 0 && $mainItemID > 0) {
                        ...
                        while ($rwItm = loc_db_fetch_array($rwItmRslt)) {
                            ...
                            $rwidx = -1;
                            $wrkngDte = DateTime::createFromFormat('d-M-Y H:i:s', $hotlChckinDocStrtDte);
                            $cmbine = true;
                            if ($cmbine) {
            ...
            if ($vwtyp == 0) {
                ...
                echo $cntent . "<li onclick=\"openATab('#allmodules', 'grp=$group&typ=$type&pg=$pgNo&vtyp=0');\">
                                    ...
                                    <span style=\"text-decoration:none;\">All Event Invoices</span>
				</li>
                               </ul>
                              </div>";
                $error = "";
                ...
                $extrWhere = " and a.doc_type IN ('Booking','Check-In') and a.fclty_type IN ('Event') and a.customer_id = COALESCE(NULLIF(" . $sbmtdInptCstmrID .
                        ",-1),a.customer_id) and y.event_doc_type='Attendance Register' and y.event_rgstr_id=COALESCE(NULLIF(" . $sbmtdRegisterID . ",-1),y.event_rgstr_id)";
                /* $extrWhere = " and a.doc_type IN ('Reservation', 'EVENT_CHECK-IN') and a.fclty_type IN ('Room/Hall','Field/Yard')";
                ...
                <form id='hotlChckinDocForm' action='' method='post' accept-charset='UTF-8'>
                    ...
                    <fieldset class=""><legend class="basic_person_lg1" style="color: #003245">ALL CHECK-INS/EVENT BOOKINGS</legend>
                            ...
                            <div class="col-md-12" style="padding:2px 1px 2px 1px !important;border-top:1px solid #ddd;border-bottom:1px solid #ddd;">
                                <?php if ($canAdd === true) { ?>   
                                    <div class="col-md-5" style="padding:0px 0px 0px 0px !important;">                      
                                        <button type="button" class="btn btn-default" style="margin-bottom: 0px;" onclick="getOneHotlChckinDocForm(-1, 3, 'ShowDialog', 'EVENT_CHECK-IN', 'EVENT_CHECK-IN');" data-toggle="tooltip" data-placement="bottom" title="Add New Check-In">
                                            <img src="cmn_images/add1-64.png" style="left: 0.5%; padding-right: 5px; height:20px; width:auto; position: relative; vertical-align: middle;">
                                            NEW CHECK-IN
                                        </button>                 
                                        <button type="button" class="btn btn-default" style="margin-bottom: 0px;" onclick="getOneHotlChckinDocForm(-1, 3, 'ShowDialog', 'Booking', 'EVENT_CHECK-IN');" data-toggle="tooltip" data-placement="bottom" title="Add New Booking/Reservation">
                                            <img src="cmn_images/add1-64.png" style="left: 0.5%; padding-right: 5px; height:20px; width:auto; position: relative; vertical-align: middle;">
                                            NEW BOOKING
                                        </button> 
                                    </div>  
                                            ...
                                            <tr id="hotlChckinDocHdrsRow_<?php echo $cntr; ?>">                                    
                                                ...
                                                <td class="lovtd">
                                                    <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="View/Edit Document" 
                                                            onclick="getOneHotlChckinDocForm(<?php echo $row[0]; ?>, 3, 'ShowDialog', '<?php echo $row[14]; ?>', 'EVENT_CHECK-IN');" style="padding:2px !important;" style="padding:2px !important;">                                                                
                                                                <?php
                                                                if ($canAdd === true) {
                                                                    ?>                                
                                                ...
                                                ?>
                                                <td class="lovtd" style="font-weight:bold;<?php echo $style1; ?>"><?php echo $row[10]; ?></td>  
                                                <?php
                                                if ($canDel === true) {
                                                    ?>
                                                    <td class="lovtd">
                ...
                if ($sbmtdHotlChckinDocID > 0) {
                    ...
                    if ($row = loc_db_fetch_array($result)) {
                        ...
                        $hotlChckinDocSrvcTyp = $row[16];
                        $hotlChckinDocRmID = (float) $row[8];
                        $hotlChckinDocRmNum = getGnrlRecNm("attn.event_price_categories", "price_ctgry_id", "price_category",
                                $hotlChckinDocRmID);

                        $sbmtdRegisterID = (float) $row[41];
                        if ($sbmtdRegisterID > 0) {
                            $sbmtdTmTblID = (float) getGnrlRecNm("attn.attn_attendance_recs_hdr", "recs_hdr_id", "time_table_id",
                                            $sbmtdRegisterID);
                            $sbmtdTmTblDetID = (float) getGnrlRecNm("attn.attn_attendance_recs_hdr", "recs_hdr_id", "time_table_det_id",
                                            $sbmtdRegisterID);
                            $sbmtdEvntID = (float) getGnrlRecNm("attn.attn_time_table_details", "time_table_det_id", "event_id",
                                            $sbmtdTmTblDetID);
                        }
                        ...
                        if ($hotlChckinDocOthrInfo == "") {
                            $hotlChckinDocOthrInfo = $hotlChckinDocSrvcTyp . " (REC. AGAINST:" . $hotlChckinDocSpnsee . " from " .
                                    $hotlChckinDocStrtDte . " to " . $hotlChckinDocEndDte . ") (" . $hotlChckinDocNum . ")";
                            /* $hotlChckinDocVchType . ": Facility No. " . $hotlChckinDocRmNum . " for " . $hotlChckinDocSpnsee . " from " .
                              $hotlChckinDocStrtDte . " to " . $hotlChckinDocEndDte . " (" . $hotlChckinDocNum . ")"; */
                        }
                    }
                    ...
                    $dte = date('ymd');
                    $docTypes = array("Rent Out", "Check-In", "Booking");
                    ...
                    <fieldset class="basic_person_fs2" style="min-height:50px !important;">
                        <div class="row" style="margin-top:5px;">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3" style="padding:0px 1px 0px 15px;">
                                        ...
                                        <input type="hidden" id="sbmtdRegisterID" value="<?php echo $sbmtdRegisterID; ?>">
                                        <input type="hidden" id="sbmtdTmTblID" value="<?php echo $sbmtdTmTblID; ?>">
                                        <input type="hidden" id="sbmtdTmTblDetID" value="<?php echo $sbmtdTmTblDetID; ?>">
                                        <input type="hidden" id="sbmtdEvntID" value="<?php echo $sbmtdEvntID; ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="hotlChckinDocSrvcTyp" class="control-label col-md-4">Linked Event:</label>
                                    <div  class="col-md-8" style="padding:0px 15px 0px 15px;">
                                        <div class="input-group" style="width:100% !important;">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'Attendance Registers (TimeTable)', 'allOtherInputOrgID', '', '', 'radio', true, '', 'sbmtdRegisterID', 'hotlChckinDocSrvcTyp', 'clear', 1, '', function () {
                                                                        getAttnEvntRgstrInfo();
                                                                    });">
                                ...
                                <div class="form-group">
                                    <label for="hotlChckinDocSrvcTyp" class="control-label col-md-4">Price Category:</label> 
                                    <div  class="col-md-8" style="padding:0px 15px 0px 15px;">
                                        <div class="input-group" style="width:100% !important;">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'Event Price Categories', 'sbmtdEvntID', '', '', 'radio', true, '', 'hotlChckinDocRmID', 'hotlChckinDocRmNum', 'clear', 1, '', function () {});">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div  class="col-md-8"> 
                                        <div class="input-group" style="width:100% !important;">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Customers and Suppliers', 'allOtherInputOrgID', 'scmSalesLnkdPrsnID', 'scmSalesInvcCstmrClsfctn', 'radio', true, '', 'hotlChckinDocSpnseeID', 'hotlChckinDocSpnsee', 'clear', 1, '', function () {
                                ...
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <label style="margin-bottom:0px !important;">No.of Persons:</label>
                                    </div>
                                    <div class="col-md-8" style="padding:0px 15px 0px 15px;">
                            ...
                            <div class = "col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <span  class="btn btn-default" style="white-space: normal !important;word-wrap:break-word !important; color:<?php echo $rqstatusColor; ?>;font-weight: bold;height:30px;font-size:12px;width:100% !important;padding:4px 1px 1px 1px !important;vertical-align:middle !important;text-align:center !important;" id="myScmSalesInvcStatusBtn">
                                            <?php
                                                    ...
                                                    <div class="col-md-4" style="padding:0px 0px 0px 0px !important;">
                                                        <div class="" style="padding:0px 0px 0px 0px;float:right !important;"> 
                                                            ...
                                                            if ($rqStatus == "Not Validated") {
                                                                ?>
                                                                <?php if ($canEdt) { ?>
                                                                    <button type="button" class="btn btn-default" style="margin-bottom: 1px;height:30px;" onclick="saveHotlChckinDocForm('<?php echo $fnccurnm; ?>', 0, 'NORMAL', 'EVENT_CHECK-IN');"><img src="cmn_images/FloppyDisk.png" style="left: 0.5%; padding-right: 5px; height:17px; width:auto; position: relative; vertical-align: middle;">Save&nbsp;</button>    
                                                                <?php } ?>
                                                                <?php if ($canRvwApprvDocs) { ?>
                                                                    <button type="button" class="btn btn-default" style="margin-bottom: 1px;height:30px;" onclick="saveHotlChckinDocForm('<?php echo $fnccurnm; ?>', 2, 'NORMAL', 'EVENT_CHECK-IN');" data-toggle="tooltip" data-placement="bottom" title="Finalize Document">
                                                    ...
                                                    <table class="table table-striped table-bordered table-responsive" id="oneScmSalesInvcSmryLinesTable" cellspacing="0" width="100%" style="width:100%;min-width: 400px !important;">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="min-width:120px;display:none;">Extra Description</th>
                ...
                while ($titleRow = loc_db_fetch_array($titleRslt)) {
                    $hotlChckinDocRmID = (float) $titleRow[0];
                    if ($hotlChckinDocRmID > 0) {
                        $hotlChckinDocRmNum = getGnrlRecNm("attn.event_price_categories", "price_ctgry_id", "price_category",
                                $hotlChckinDocRmID);
                        break;
                ...
                $arr_content['hotlChckinDocRmID'] = $hotlChckinDocRmID;
                $arr_content['hotlChckinDocRmNum'] = $hotlChckinDocRmNum;
