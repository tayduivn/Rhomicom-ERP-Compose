                                                ...
                                                <div class="row"><!-- ROW 2 -->                                
                                                    ...
                                                    <div class="col-lg-6"> 
                                                        <fieldset class="basic_person_fs5"><legend class="basic_person_lg1">Registration Details</legend>
                                                            ...
                                                            <div <?php echo $makeHidden; ?> class="form-group form-group-sm">
                                                                <?php if($cnt > 0 && $row[11] != $rowATZ11) { ?>
                                                                <label data-toggle="tooltip" title="<?php echo $rowATZ11; ?>" for="regNo" class="control-label col-md-4"><a href="#" style="color:red;" onclick="dsplyAuthrzdData('<?php echo $rowATZ11; ?>');">Business Reg. No:</a></label>
                                                                <?php } else { ?>
                                                                <label for="regNo" class="control-label col-md-4">Business Reg. No:</label>
                                                                <?php } ?>
                                                                <div  class="col-md-8">
                                                                    <input <?php echo $mkReadOnly; ?> class="form-control rqrdFld" id="regNo" type = "text" placeholder="Business Registration No" value="<?php echo $row[11]; ?>"/>
                                                                </div>                                                                   
                                                            </div>                                                            
                                                            <div <?php echo $makeHidden; ?> class="form-group form-group-sm">
                                                                <?php if($cnt > 0 && $row[19] != $rowATZ19) { ?>
