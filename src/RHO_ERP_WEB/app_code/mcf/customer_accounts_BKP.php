    ...
    if ($pkID > 0) {
        ...
        echo $cntent .= "
            ...
            if ($vwtyp == 0) {
                ...
                $total = get_CustAccountsTtl($statusSrchIn, $branchSrchIn, $prdtTypeSrchIn, $isEnabledOnly, $srchFor, $srchIn, $orgID, $searchAll);
                ...
                $curIdx = $pageNo - 1;
                $result = get_CustAccounts($statusSrchIn, $branchSrchIn, $prdtTypeSrchIn, $isEnabledOnly, $srchFor, $srchIn, $curIdx, $lmtSze, $orgID, $searchAll, $sortBy);
                $cntr = 0;
                            ...
                            <div class="col-md-8" style="float:right !important;">
                                <div class="col-lg-12" style="margin-bottom: 1px;"><!-- style="padding: 5px 1px 0px 15px !important">-->
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-filter"></span></span>
                                        <select class="form-control" id="dataAdminPrdtTypeSrchIn" onchange="">
