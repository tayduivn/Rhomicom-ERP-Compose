...
$canAddRqsts = test_prmssns($dfltPrvldgs[9], $mdlNm);
$canEdtRqsts = test_prmssns($dfltPrvldgs[10], $mdlNm);
$canDelRqsts = test_prmssns($dfltPrvldgs[11], $mdlNm);
        ...
        if ($qstr == "DELETE") {
            ...
            if ($vwtyp == 0) {
                echo $cntent . "<li onclick=\"openATab('#allmodules', 'grp=$group&typ=$type&pg=$pgNo&vtyp=0');\">
                                    ...
                                    <span style=\"text-decoration:none;\">To Resolve</span>
				</li>
                               </ul>
                              </div>";
                ...
                $total = get_AllTicketsTtl($srchFor, $srchIn, $orgID, $qStrtDte, $qEndDte, $qNotClosed, FALSE, TRUE);
                ...
                $curIdx = $pageNo - 1;
                $result = get_AllTickets($srchFor, $srchIn, $curIdx, $lmtSze, $orgID, $qStrtDte, $qEndDte, $qNotClosed, FALSE, TRUE);
                $cntr = 0;
                ?> 
