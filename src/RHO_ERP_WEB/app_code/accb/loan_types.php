                                ...
                                <div class="<?php echo $colClassType2; ?>" style="padding:0px 15px 0px 15px !important;">
                                    <div class="input-group">
                                        <input class="form-control" id="payTransTypsSrchFor" type="text" placeholder="Search For" value="<?php
                                                                                                                                            ...
                                                                                                                                            ?>" onkeyup="enterKeyFuncPayTransTyps(event, '', '#allmodules', 'grp=6&typ=1&pg=<?php echo $pgNo; ?>&vtyp=0');">
                                        <input id="payTransTypsPageNo" type="hidden" value="<?php echo $pageNo; ?>">
                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getPayTransTyps('clear', '#allmodules', 'grp=6&typ=1&pg=<?php echo $pgNo; ?>&vtyp=0');">
                                            <span class="glyphicon glyphicon-remove"></span>
                                        </label>
                                        <label class="btn btn-primary btn-file input-group-addon" onclick="getPayTransTyps('', '#allmodules', 'grp=6&typ=1&pg=<?php echo $pgNo; ?>&vtyp=0');">
                                ...
                                <div class="<?php echo $colClassType1; ?>">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination" style="margin: 0px !important;">
                                            <li>
                                                <a href="javascript:getPayTransTyps('previous', '#allmodules', 'grp=6&typ=1&pg=<?php echo $pgNo; ?>&vtyp=0');" aria-label="Previous">
                                                    <span aria-hidden="true">&laquo;</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="javascript:getPayTransTyps('next', '#allmodules', 'grp=6&typ=1&pg=<?php echo $pgNo; ?>&vtyp=0');" aria-label="Next">
